            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class=<%=home%>><a href="adminHome"><i class="fa fa-home"></i> Home </a>
                   
                  </li>
                  <li class=<%=Ride %>><a href="acceptRide"><i class="fa fa-edit"></i> Ride Requests </a>
                  
                  </li>
                  <li class=<%=Rent %>><a href="acceptRent"><i class="fa fa-desktop"></i> Rent Requests </a>
